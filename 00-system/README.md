...
The operating machinery of the Initiative Launch System — not content, not a project.

- [ai/](ai/) — instructions for AI collaborators, built on [ai/PRINCIPLES.md](ai/PRINCIPLES.md)
- [templates/](templates/) — canonical starting points for every kind of file; use one before improvising a new format
...
- [workflow-protocol-v0.3.md](workflow-protocol-v0.3.md) — operational protocol for prompt completeness, repository verification, recovery, autonomous execution and batch documentation work, per decision [006](../04-decisions/006-operational-workflow-protocol-v0.3.md)
