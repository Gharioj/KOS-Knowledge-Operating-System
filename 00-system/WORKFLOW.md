...
Standard procedure for working across repositories and devices in a cloud-first setup. Applies to every repository cloned locally — the Initiative Lifecycle System repository and any project-specific public repository alike.
